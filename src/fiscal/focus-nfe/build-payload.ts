...
export function buildFocusNFePayload(
  ...
  const payload: FocusNFePayload = {
    ...
    modalidade_frete: (pedido as Record<string, unknown>).modalidade_frete as string | undefined ?? '0',
    ...(pedido as Record<string, unknown>).cnpj_transportador != null && { cnpj_transportador: String((pedido as Record<string, unknown>).cnpj_transportador) },
    ...(pedido as Record<string, unknown>).cpf_transportador != null && { cpf_transportador: String((pedido as Record<string, unknown>).cpf_transportador) },
    ...(pedido as Record<string, unknown>).nome_transportador != null && { nome_transportador: String((pedido as Record<string, unknown>).nome_transportador) },
    ...(pedido as Record<string, unknown>).inscricao_estadual_transportador != null && { inscricao_estadual_transportador: String((pedido as Record<string, unknown>).inscricao_estadual_transportador) },
    ...(pedido as Record<string, unknown>).endereco_transportador != null && { endereco_transportador: String((pedido as Record<string, unknown>).endereco_transportador) },
    ...(pedido as Record<string, unknown>).municipio_transportador != null && { municipio_transportador: String((pedido as Record<string, unknown>).municipio_transportador) },
    ...(pedido as Record<string, unknown>).uf_transportador != null && { uf_transportador: String((pedido as Record<string, unknown>).uf_transportador) },
    ...(pedido as Record<string, unknown>).quantidade_volumes != null && { quantidade_volumes: String((pedido as Record<string, unknown>).quantidade_volumes) },
    ...(pedido as Record<string, unknown>).peso_bruto_volumes != null && { peso_bruto_volumes: Number((pedido as Record<string, unknown>).peso_bruto_volumes) },
    ...(pedido as Record<string, unknown>).peso_liquido_volumes != null && { peso_liquido_volumes: Number((pedido as Record<string, unknown>).peso_liquido_volumes) },
    ...(pedido as Record<string, unknown>).numeracao_volumes != null && { numeracao_volumes: String((pedido as Record<string, unknown>).numeracao_volumes) },
    ...(pedido as Record<string, unknown>).marca_volumes != null && { marca_volumes: String((pedido as Record<string, unknown>).marca_volumes) },
    ...(pedido as Record<string, unknown>).especie_volumes != null && { especie_volumes: String((pedido as Record<string, unknown>).especie_volumes) },
